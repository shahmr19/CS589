...
def main():
    ...
    plt.xlabel("k")
    plt.ylabel("Accuracy")
    plt.title("Digits k-NN Accuracy vs k using 10-Fold Stratified CV")
    plt.grid(True)
    plt.savefig("digits_knn_accuracy_cv.png")
    plt.close()
    ...
    plt.title("Digits k-NN Macro F1 vs k using 10-Fold Stratified CV")
    plt.grid(True)
    plt.savefig("digits_knn_f1_cv.png")
    plt.close()
